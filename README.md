...
-Ce projet a également marqué une première utilisation de GitHub. L’ensemble du travail a permis d’apprendre à gérer un dépôt, organiser des commits significatifs, versionner proprement le code et comprendre l’intérêt d’un historique clair pour suivre l’évolution du projet. GitHub a aussi révélé son utilité dans la collaboration, la sauvegarde du code et la structuration d’un workflow professionnel. Aussi Hébergement du projet sur GitHub Pages avec le lien suivant :
https://elwess33070.github.io/Mihoub_Wissem_App_CRUD_Etudiants/
